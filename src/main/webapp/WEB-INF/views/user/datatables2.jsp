...
<title>datatables</title>
    ...
    <link href="${ctxStatic}/js/plugins/datetimepicker/css/bootstrap-datetimepicker.css" rel="stylesheet" type="text/css" />
</head>
<body>
	<!-- head star -->
	                     ...
	                     <div class="col-lg-4 col-sm-3 pl0">
		                     <div class="form-group">
		                           <div class="col-lg-8 col-sm-7">
		                                 <select class="input-sm form-control input-s-sm inline" id="loginFlag">
	                     ...
	                     <div class="col-lg-4 col-sm-5">
		                     <div class="form-group">
		                           ...
		                           <div class="col-lg-8 col-sm-8 input-group date">
		                                 ...
		                                 <input type="text"  class="input-sm form-control form_datetime" id="startTime" readonly>
		                                 <span class="input-group-addon">到</span>
		                                 <input type="text"  class="input-sm form-control form_datetime" id="endTime" readonly>
		                           </div>
		                     </div>
	                     </div>
	                     <div class="col-lg-4 col-sm-4">
		                	<div class="form-group">
		                           <div class="col-lg-12 col-sm-12 input-group">
		                                 <input type="text" placeholder="请输入关键字" class="input-sm form-control" id="name">
...
<script type="text/javascript" src="${ctxStatic}/js/plugins/datetimepicker/js/bootstrap-datetimepicker.js"></script>
<script type="text/javascript" src="${ctxStatic}/js/moment.min.js"></script>
<script type="text/javascript">
	$(function(){
        $(".form_datetime").datetimepicker({format:'yyyy-mm-dd hh:ii',todayBtn:true,showMeridian:true,autoclose:true});
           ...
           "fnDrawCallback":function( settings ) {//表格重绘时触发
